<nav x-data="{ open: false }" class="bg-gray-800  border-b border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current bg-white text-indigo-400" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center space-x-4">
                ...
                <a href="{{ route('market-data.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="bg-gray-800 border border-gray-700">
                            <x-dropdown-link :href="route('profile.edit')" class="text-white hover:bg-gray-700 hover:text-white">
                                {{ __('Profile') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Mobile Action Links -->
            <x-responsive-nav-link :href="route('market-data.create')" class="text-emerald-400 hover:bg-gray-700 hover:text-white">
                {{ __('Submit New Data') }}
            </x-responsive-nav-link>
            
            <x-responsive-nav-link :href="route('market-data.import')" class="text-purple-400 hover:bg-gray-700 hover:text-white">
                {{ __('Bulk Import') }}
            </x-responsive-nav-link>
