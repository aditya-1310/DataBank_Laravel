                ...
                <div class="p-6 text-gray-900">
                    @if($pendingData->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">All market data submissions have been approved.</p>
                        </div>
                    @else
                                    ...
                                    @foreach($pendingData as $item)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                <form action="{{ route('market-data.destroy', $item->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
